...
`openspec/` · rules `paths:`-scoped in `.claude/rules/` · skills canonical in `.agents/skills/`, `.claude/skills` and
`.codex/skills` generated by `python3 scripts/sync-agent-files.py --apply` (never hand-edit them).
